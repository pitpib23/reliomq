...
def main() -> None:
    ...
    # The equivalent explicit configuration; adjust for your stream.
    mode = FastMode(
    ...
    # Count/byte high water, maximum age, a sustained disconnect, a delivery
    # retry timeout, or clean shutdown spills oldest messages in bounded
    # batches. RAM-only messages can be lost on sudden power failure.
